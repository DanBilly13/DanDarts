-- =====================================================
-- DanDarts Database Migration 066
-- Save Remote Visit RPC Function
-- =====================================================
-- Purpose: Atomically save remote match visits with match_throws insertion
-- Date: 2026-03-06
-- 
-- DESIGN:
-- - Single RPC function handles visit saving + match_throws insertion
-- - Canonical player_order: challenger_id=0, receiver_id=1
-- - Per-player turn_index computation
...
GRANT EXECUTE ON FUNCTION save_remote_visit TO authenticated;

-- ============================================
-- ADD COMMENT
-- ============================================

COMMENT ON FUNCTION save_remote_visit IS 
'Atomically saves a remote match visit: inserts match_throws row and updates matches table. SECURITY DEFINER ensures RLS bypass for atomic operation. Canonical player_order: challenger_id=0, receiver_id=1.';
...
BEGIN
    ...
    RAISE NOTICE 'Created: save_remote_visit RPC function';
    RAISE NOTICE 'Purpose: Atomic remote visit saving with match_throws insertion';
    RAISE NOTICE 'Player Order: challenger_id=0, receiver_id=1';
    RAISE NOTICE '========================================';
END $$;
...
--
-- BEGIN;
-- DROP FUNCTION IF EXISTS save_remote_visit;
-- COMMIT;
--
-- ============================================
