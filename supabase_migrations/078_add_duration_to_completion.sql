-- =====================================================
-- DanDarts Database Migration 078
-- Add Duration Calculation to Match Completion
-- =====================================================
-- Purpose: Calculate duration when match completes in save_remote_visit
-- Date: 2026-03-12
-- 
-- DESIGN:
-- - started_at is set by join-match when lobby → in_progress
-- - duration is calculated by save_remote_visit when match completes
-- - Uses COALESCE to handle edge case of instant wins
-- =====================================================
...
BEGIN
    ...
    IF v_winner_id IS NOT NULL THEN
        -- Match completed - calculate duration using COALESCE for safety
        UPDATE matches SET
...
BEGIN
    ...
    RAISE NOTICE 'Updated: save_remote_visit';
    RAISE NOTICE 'Added: Duration calculation on completion';
    RAISE NOTICE '========================================';
END $$;
