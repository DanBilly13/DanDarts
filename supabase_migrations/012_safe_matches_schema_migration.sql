...
-- Safe matches schema migration - handles existing objects
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view match_throws for their matches" ON public.match_throws;
DROP POLICY IF EXISTS "Authenticated users can insert match_throws" ON public.match_throws;

-- STEP 7: Create RLS policies for match_players
...
-- STEP 8: Create RLS policies for match_throws
...
DO $$
BEGIN
    RAISE NOTICE 'Safe matches schema migration successful!';
